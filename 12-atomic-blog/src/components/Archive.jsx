...
const Archive = ({ onAddPost }) => {
    ...
    // use this trick as an optimization technique, because if we just used a
    // regular variable, these posts would be re-created on every render. We
    // could also move the posts outside the components, but I wanted to show
    // you this trick 😉
